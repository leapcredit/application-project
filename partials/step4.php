    ...
    <form class="form" id="step-form-4" novalidate>
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <span>* </span>
                <input type="text" required class="form-control" id="stp4mincome" />
            </div>
            <div class="form-group  col-md-6">
                <label for="stp4isource">Income Source</label>
                <span>* </span>
                <input type="text" required class="form-control" id="stp4isource" />
            </div>
        </div>
        <div class="form-goup">
        ...
        <div class="form-row">
            <div class="form-group col-md-4">
                ...
                <span>* </span>
                <select class="custom-select" id="stp4pfrecuency">
            ...
            <div class="form-group  col-md-5">
                ...
                <span>* </span>
                <input id="stp4npdate" class="calendar" />
            </div>
            <div class="form-group  col-md-3">
                <label for="stp4ddeposit">Direct Deposit</label>
                <span>* </span>
                <select class="custom-select" id="stp4ddeposit">
        ...
        <div class="form-row">
            <div class="form-group col-md-7">
                ...
                <span>* </span>
                <input type="text" class="form-control" id="stp4employer" />
            </div>
            <div class="form-group  col-md-5">
                <label for="stp4cphone">Cell Phone</label>
                <span>* </span>
                <input type="text" class="form-control" id="stp4cphone" />
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <span>* </span>
            <input type="email" class="form-control" id="stp4address1" />
        </div>
        <div class="form-group">
        ...
        <div class="form-row">
            <div class="col-md-8">
                ...
                <input type="text" class="form-control" id="stp4jtitle" />
            </div>
            <div class="col-md-4">
