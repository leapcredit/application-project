<section class="container col-md-7 step step-5 step-hidden p-4 p-lg-5">
    <form class="form" id="step-form-5">
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <span>* </span>
                <input type="text" required class="form-control" id="stp5anumber" />
            </div>
            <div class="form-group  col-md-6">
                <label for="stp5rnumber">Routing Number</label>
                <span>* </span>
                <input type="text" class="form-control" id="stp5rnumber" />
            </div>
        </div>
        ...
        <div class="form-row">
            <div class="col-md-6">
                ...
                <span>* </span>
                <select class="custom-select" id="stp5atype">
