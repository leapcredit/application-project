    ...
    <form class="form" id="step-form-6">
        ...
        <div class="form-row">
            <div class="form-group pt-3 col-md-6">
                ...
                <span>* </span>
                <input type="text" class="form-control" id="rcrAccNumber" />
            ...
            <div class="form-group pt-3 col-md-6">
                ...
                <span>* </span>
                <input type="text" class="form-control" id="rcrRoutingNumber" />
        ...
        <div class="form-row">
            <div class="form-group col-12">
                ...
                <span>* </span>
                <input type="text" class="form-control" id="rcrCustAddress" />
            </div>
            <div class="form-group  col-12">
