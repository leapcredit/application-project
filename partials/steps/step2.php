    ...
    <section class="container  p-4 p-lg-5">
        <form class="form" id="step-form-2" novalidate>
            ...
            <div class="form-group">
                ...
                <input type="email" required class="form-control" id="stp2email" placeholder="youremail@example.com" />
            </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" pattern="^(?!000|666)[0-8][0-9]{2}-(?!00)[0-9]{2}-(?!0000)[0-9]{4}$" required
                        class="form-control" id="stp2ssn" placeholder="           -              -        " />
                    <div class="invalid-feedback">Please use 000-00-0000 format</div>
                </div>
                <div class="form-group  col-md-6">
                    <label for="stp2dob">Date of Birth</label>
                    <input required pattern="^(0[1-9]|1[012])[- /.](0[1-9]|[12][0-9]|3[01])[- /.](19|20)\d\d$"
                        id="stp2dob" class="calendar" placeholder="MM / DD / YYYY" />
                </div>
            </div>
