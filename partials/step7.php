<section class="container col-md-7 step step-7 step-hidden p-4 p-lg-5">
    <form class="form" id="step-form-6">
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <span>* </span>
                <input type="text" class="form-control" id="rcrCustMI" />
            </div>
            <div class="form-group  col-md-6">
                <label for="rcrCustEmp">Employer</label>
                <span>* </span>
                <input type="text" class="form-control" id="rcrCustEmp" />
            </div>
        </div>
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <select class="custom-select" id="rcrCustpfrecuency">
            ...
            <div class="form-group  col-md-6">
                ...
                <input id="rcrCustnpdate" class="calendar" />
            </div>
        </div>
